<!DOCTYPE html>
  <html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="https://use.typekit.net/jhj8lgl.css">
        ...
        <link rel="stylesheet" href="http://localhost/event_machine/public/css/main.css">
        <script src="http://localhost/event_machine/public/js/main.js"></script>
    </head>
    <body>
